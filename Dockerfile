...
# gclone latest
RUN aria2c https://github.com/dogbutcat/gclone/releases/download/v1.59.0-mod1.5.0/gclone-v1.59.0-mod1.5.0-linux-amd64.zip && \
    unzip gclone-v1.59.0-mod1.5.0-linux-amd64.zip && mv gclone-v1.59.0-mod1.5.0-linux-amd64/gclone /usr/bin && chmod +x /usr/bin/gclone && rm -r gclone-v1.59.0-mod1.5.0-linux-amd64
