...
# gclone latest
RUN aria2c https://github.com/l3v11/gclone/releases/download/v1.61.1-cold/gclone-v1.61.1-cold-linux-amd64.zip && \
    unzip gclone-v1.61.1-cold-linux-amd64.zip && mv gclone-v1.61.1-cold-linux-amd64/gclone /usr/bin && chmod +x /usr/bin/gclone && rm -r gclone-v1.61.1-cold-linux-amd64
